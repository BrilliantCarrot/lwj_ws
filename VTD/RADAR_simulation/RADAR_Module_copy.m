function [sig,sigma_MBc, sigma_SLc, sigma_clutter] = RADAR_Module_copy(RADAR,PosN,lambda_num,X,Y,Z)
...
% Reference Radar : S-band(RL-2000/GCI), X-band(Scanter 4000)
    ...
    % else
        ...
        % SIR = 1./((1./sig_temp)+(1./SCR));       % 클러터의 영향이 고려된 목표물의 SNR 값을 SIR(SCNR)로 정의
